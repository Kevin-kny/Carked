...
CREATE TABLE "DealershipInfo" (
    "id" TEXT NOT NULL,
    "name" TEXT NOT NULL DEFAULT 'Carked Limited',
    "address" TEXT NOT NULL DEFAULT '42 Ridgeview Drive, Thindigua, Kenya 00619',
    "phone" TEXT NOT NULL DEFAULT '+254 (700) 381-1168',
    "email" TEXT NOT NULL DEFAULT 'contact@carked.in',
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
