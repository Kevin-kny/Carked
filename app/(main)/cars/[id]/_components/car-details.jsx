...
import {Car,Fuel,Gauge, LocateFixed, Share2, Heart, MessageSquare, Currency } from "lucide-react";
    ...
    if (navigator.share) {
      navigator
        .share({
          ...
          text: `Check out this ${car.year} ${car.make} ${car.model} on Carked!`,
      ...
      <div className="flex flex-col lg:flex-row gap-8">
        ...
        <div className="w-full lg:w-5/12">
          ...
          <Dialog>
              ...
              <Card className="pt-5">
                <CardContent>
                  ...
                  <div className="text-xs text-gray-500 mt-1">
                    *Based on ksh. 0 down payment and 4.5% interest rate
                  </div>
                </CardContent>
              </Card>
            </DialogTrigger>
            <DialogContent>
              <DialogHeader>
                <DialogTitle>Carked Loan EMI Calculator</DialogTitle>
        ...
        <div className="bg-gray-50 rounded-lg p-6">
          <div className="flex flex-col md:flex-row gap-6 justify-between">
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                <h4 className="font-medium">Carked Limited</h4>
