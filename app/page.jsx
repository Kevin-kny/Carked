...
export default async function Home() {
  ...
  return (
    <div className="pt-20 flex flex-col">
      <section className="relative py-16 md:py-28 dotted-background text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="mt-6 text-lg text-gray-300 max-w-2xl mx-auto">
            Browse thousands of listings, compare prices, and drive away happy.
          </p>

          <p className="mt-6 text-lg text-gray-300 max-w-2xl mx-auto">
           Try our newly added Smart Search to find your ideal car!
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <div className="bg-blue-100 text-blue-700 rounded-full w-16 h-16 flex items-center justify-center mx-auto mb-4">
                ...
                <p className="text-gray-600"> Book a test drive now, with flexible scheduling options.</p>
              </div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
             ...
             >
              <div className="overflow-hidden rounded-lg flex justify-end h-28 mb-4 relative">
                <Image src={type.image} alt={type.name} fill className="object-cover group-hover:scale-105 transition duration-300"/>
              </div>
